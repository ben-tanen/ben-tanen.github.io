...
<script>
    ...
    // SPA routing for actor-ages — store the deep path and redirect to the app shell
    else if (url[3] === 'projects' && url[4] === 'actor-ages') {
        var deepPath = '/' + url.slice(5).join('/');
        sessionStorage.setItem('actor-ages-redirect', deepPath);
        new_url = '/projects/actor-ages/';
    }
    ...
    if (new_url) {
        ...
        window.location = window.location.protocol + '//' + url[2] + new_url;
    }
</script>