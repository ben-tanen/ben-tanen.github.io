...
thumbnail: /assets/img/posts/thumbnail/spotify-popularity.png
---
...
{% include figure.html src="/assets/img/posts/spotify_popularity.png" alt="A graph of my Spotify popularity over time" %}
