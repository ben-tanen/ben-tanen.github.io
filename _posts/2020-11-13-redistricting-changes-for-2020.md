...
{% include figure.html src="/assets/img/posts/redistricting-changes-for-2020-8aeaf5fa.png" alt="A visualization showing how redistricting control has changed from 2011 to today based on changes in legislative control and ballot initiatives changing the process" link="/assets/img/posts/redistricting-sankey-horiz.png" %}
...
<div class="columns two">
    <div class="column">
        {% include figure.html src="/assets/img/posts/redistricting-changes-for-2020-f7b16ec5.png" alt="A map of TX-35 Congressional district, a key example of a gerrymandered district" caption="Texas' 35th Congressional district, a classic example of an extreme gerrymander, cracking communities between both San Antonio and Austin" link="https://www.washingtonpost.com/news/wonk/wp/2014/05/15/americas-most-gerrymandered-congressional-districts/" %}
    </div>
    <div class="column">
...
Control of the redistricting process was determined based on information from [The Princeton Gerrymandering Project](https://gerrymander.princeton.edu/) and [Loyola Law School’s All About Redistricting](https://redistricting.lls.edu/index.php).

	The number of electoral votes allocated to each state in 2021 is based on [2019 Census Estimates from Election Data Services](https://www.electiondataservices.com/wp-content/uploads/2019/12/NR_Appor19wTablesMaps.pdf#page=3), which shows AZ, CO, FL, MT, NC, OR, TX gaining seats and AL, CA, IL, MI, MN, NY, OH, PA, RI, WV losing seats. If Montana gains a seat, it will require redistricting (they currently only have one district) but their redistricting will be done by an independent commission. If Rhode Island loses a seat, they will only have one district, therefore not requiring any redistricting.

	While many state legislature races are still undecided (as of 11/13/2020), [most outlets are projecting](https://www.nhpr.org/post/new-hampshire-s-was-only-state-legislature-changed-parties-2020-election) that New Hampshire is the only state that will see any change in their state legislature, switching from Democratic to Republican control in both chambers.
{% endcapture %}
