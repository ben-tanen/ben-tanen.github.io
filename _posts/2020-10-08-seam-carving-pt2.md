...
<div class="columns two">
    <div class="column">
        {% include figure.html src="/assets/img/posts/seam-carving-pt2-f623098f.png" alt="An image of a giraffe sticking it's tongue out" caption="An example of what 'open for surprise' might reveal" width="500" %}
    </div>
    <div class="column">
...
<style>
div.column:nth-of-type(1) { width: calc(40% - 15px) !important; }
div.column:nth-of-type(2) { width: calc(60% - 15px) !important; }
</style>
...
{% include tweet.html url="https://twitter.com/bascule/status/1307440596668182528" text="Trying a horrible experiment… Which will the Twitter algorithm pick: Mitch McConnell or Barack Obama" author="@bascule" %}
...
To illustrate how what could happen when we just "let the computer figure it out," I present a few examples where I used [a seam carving algorithm]({% post_url 2020-10-08-seam-carving-pt1 %}) to generate feed-friendly images. *TL;DR of the results:* it's not great...
