...
thumbnail: /assets/img/post-thumbnails/sundance-tickets-11def6e1.webp
---
...
{% include figure.html src="/assets/img/posts/sundance-tickets-41b30e4c.png" alt="A screenshot of the logs from my code showing two available screenings on January 29" %}
...
{% include figure.html src="/assets/img/posts/sundance-tickets-f51f1418.png" alt="A screenshot of the logs from my code showing a premiere screening for Buddy with emojis indicating it played sound" %}
