...
thumbnail: /assets/img/post-thumbnails/clustering-with-kmeans-34cc6291.gif
---
...
{% include figure.html src="/assets/img/posts/clustering-with-kmeans-3edc18ea.png" alt="Graphs comparing the known and unknown clusters in some random data" autolink="yes" width="700px" %}
...
{% include figure.html src="/assets/img/posts/clustering-with-kmeans-6a769ed1.gif" alt="A GIF visualizing the k-means clustering algorithm" autolink="yes" width="450px" %}
