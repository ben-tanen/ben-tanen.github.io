...
{% include footnote-content.html id="footnote-1" content="<img src='/projects/most-font/img/stacked_H_old.png' width='100%' />" %}
{% include footnote-content.html id="footnote-2" content="Interestingly, in a response describing the high or low vertex, the responder captured the essence of most of these design decisions: That's just one of hundreds of type design decisions with endless amounts of gradual options." %}
{% include footnote-content.html id="footnote-3" content="See the methodology section below." %}