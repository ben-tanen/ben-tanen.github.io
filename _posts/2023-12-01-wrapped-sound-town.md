...
{% include figure.html src="/assets/img/posts/wrapped-sound-town-cf3c7042.png" caption='The original pitch slide for "Musical Hometown", now "Sound Town", in Wrapped 2023' autolink="yes" %}
...
<div class="columns two">
    <div class="column">
        {% include tweet.html url="https://twitter.com/brokebackstan/status/1729880433326973270" text="spotify is trying to make a gay commune in berkeley, a lesbian commune in burlington, and a bisexual commune in cambridge" author="carey (@brokebackstan)" %}
    </div>
    <div class="column">
        {% include tweet.html url="https://twitter.com/nytimes/status/1730191218930323500" text="Do you listen to a lot of Noah Kahan? How about boygenius? Taylor Swift? Odie Leigh? Car Seat Headrest? Indigo Girls? Brandi Carlile?  It might be time for you to visit Burlington, Vermont. Spotify thinks you’ll be in good company there." author="The New York Times (@nytimes)" %}
    </div>
</div>
...
<div class="columns two">
    ...
    <div class="column">
        {% include figure.html src="/assets/img/posts/wrapped-sound-town-fcd08637.png" caption="I'll be shipping off to Hobart, Australia apparently, based on my enjoyment of Middle Kids, Angie McMahon, and The Rubens" autolink="yes" width="250" %}
    </div>
</div>

<div class="columns two">
    <div class="column">
        {% include tweet.html url="https://twitter.com/davejorgenson/status/1729920917017375221" text="is Spotify working with the government to populate smaller cities" author="Dave Jorgenson (@davejorgenson)" %}

        {% include tweet.html url="https://twitter.com/ali_sivi/status/1729888766935097804" text="american high-speed railway system connecting the berkeley, burlington, and cambridge spotify crowds" author="bald ann dowd (@ali_sivi)" %}

        {% include tweet.html url="https://twitter.com/yourbuddyash/status/1729889198788776074" %}

        {% include tweet.html url="https://twitter.com/nagy_minaj/status/1729870017259536387" %}

        {% include tweet.html url="https://twitter.com/raspberhrriies/status/1729894731868782702" %}

        {% include tweet.html url="https://twitter.com/aubrey031018/status/1730076142579630206" %}
    </div>
    <div class="column">
        {% include tweet.html url="https://twitter.com/abbyemonteil/status/1729886593639694344" text="does she…you know…have spotify listening habits in common with berkeley, burlington, or cambridge?" author="abby monteil (@abbyemonteil)" %}

        {% include tweet.html url="https://twitter.com/HarryPhillips15/status/1729863718232568180" %}

        {% include tweet.html url="https://twitter.com/sam_alberti/status/1729927105410945204" %}

        {% include tweet.html url="https://twitter.com/ljinthealps/status/1729963679477551388" text="LGBT actually stands for Let’s Go to Burlington Together" author="lj (@ljnthealps)" %}

        {% include tweet.html url="https://twitter.com/megab00f/status/1729894673664413874" %}

        {% include tweet.html url="https://twitter.com/Spotify/status/1730611582152180194" %}
    </div>
</div>
