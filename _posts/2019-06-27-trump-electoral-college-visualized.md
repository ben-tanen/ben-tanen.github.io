...
function render_blocks() {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        ec_paths_svg.append("rect")
            ...
            .attr("height", y(y.domain()[1] - d.ecvotes) - 1.5);
