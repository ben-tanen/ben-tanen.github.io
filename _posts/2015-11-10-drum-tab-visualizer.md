...
thumbnail: /assets/img/post-thumbnails/drum-tab-visualizer-e637ebe0.gif
---
...
<div class="columns two">
    ...
    <div class="column">
        {% include figure.html src="/assets/img/posts/drum-tab-visualizer-8407b1f4.gif" alt="Fish animation via the command-line" width="400px" %}
    </div>
</div>
...
{% include figure.html src="/assets/img/posts/drum-tab-visualizer-44422e08.gif" alt="Demo GIF of the drum tab visualizer" %}
