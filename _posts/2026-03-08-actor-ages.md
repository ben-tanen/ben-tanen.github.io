...
thumbnail: /assets/img/post-thumbnails/actor-ages-83deab54.webp
---
...
{% include figure.html src="/assets/img/posts/actor-ages-55bd5fb6.png" alt="A screenshot of the Actor Ages project showing the actors and their respective ages from the S1E1 Premiere episode of The O.C." width="500" %}
...
{% include figure.html src="/assets/img/posts/actor-ages-6b1a7cce.png" alt="A screenshot of the Actor Ages project showing search results (including posters and release years) for TV shows matching to the oc" width="500" %}
