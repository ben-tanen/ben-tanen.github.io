...
{% include youtube.html id="p3Uos2fzIJ0" %}
...
{% include figure.html src="/assets/img/posts/retro-game-theory-6a965bbd.png" alt="A payoff matrix for the slapping game" caption="Playful violence is always fun" %}
...
{% include figure.html src="/assets/img/posts/retro-game-theory-9657912b.png" alt="A payoff matrix for the drinking game" caption="Who doesn't love economic-based drinking games?" %}
