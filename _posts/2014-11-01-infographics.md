...
{% include figure.html src="/assets/img/posts/infographics-b13079e5.png" caption="Examples of Kerem's use of infographics" %}
...
{% include figure.html src="/assets/img/posts/infographics-45337f41.png" caption="My own example infographics" %}
...
**Update, 12/24/2020** - I’ve updated my home page to remove this text, so this information isn’t available anywhere anymore! Feel free to reach out to me if you really want to know what I’m listening to currently.
