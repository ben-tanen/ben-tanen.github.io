...
thumbnail: /assets/img/post-thumbnails/rodrego-34d3d6a1.png
---

{% include figure.html src="/assets/img/posts/rodrego-e0236d91.png" alt="RodRego's Original Banner" %}
...
{% include figure.html src="/assets/img/posts/rodrego-fc6d5da9.png" caption="The original desktop application (left) vs. the new web application (right)" autolink="yes" %}
