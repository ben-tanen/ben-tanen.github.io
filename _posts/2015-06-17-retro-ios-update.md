...
thumbnail: /assets/img/post-thumbnails/retro-ios-update-d0d4e5f7.gif
---
...
{% include figure.html src="/assets/img/posts/retro-ios-update-803244fd.gif" alt="A simulated screen capture of the text delay feature" caption="Delay a text to send a few minutes (or even a few hours)" autolink="yes" width="230px" %}
...
{% include figure.html src="/assets/img/posts/retro-ios-update-2f2c54f2.gif" alt="A simulated screen capture of the in-app texting feature" caption="Update - More or less is exactly what the actual implementation looks like" autolink="yes" width="230px" %}
